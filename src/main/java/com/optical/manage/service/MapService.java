...
public interface MapService {
    ...
    // 路由段操作
    Long createRouting(RoutingRequest request);
    Routing getRouting(Long id);
    boolean updateRouting(Long id, RoutingRequest request);
